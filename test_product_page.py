...
class TestGuestLoginPageAndLink:
...
class TestGuestMessageProductToBasket:
    @pytest.mark.xfail
    def test_message_disappeared_after_adding_product_to_basket(self, browser):
        ...
        page.open()
        page.add_in_basket()
        page.should_not_be_success_message_alert_after()
...
class TestGuestNotSeeProductInBasket():
